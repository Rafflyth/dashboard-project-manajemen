                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-row">
                                                <a class="button-link view" href="messages.php?detail=<?php echo (int)$msg['id']; ?>">👁 Detail</a>
                                                <?php if ((int)$msg['sender_user_id'] === (int)$user['id']): ?>
                                                    <a class="button-link edit" href="messages.php?edit=<?php echo (int)$msg['id']; ?>">✎ Edit</a>
                                                    <a class="button-link delete" href="messages.php?delete=<?php echo (int)$msg['id']; ?>" onclick="return confirm('Hapus pesan ini?');">🗑 Hapus</a>
                                                <?php else: ?>

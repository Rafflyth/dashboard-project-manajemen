                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-row">
                                                <a class="button-link view" href="plans.php?status=<?php echo urlencode($statusFilter); ?>&detail=<?php echo (int)$plan['id']; ?>">👁 Detail</a>
                                                <a class="button-link edit" href="plans.php?edit=<?php echo (int)$plan['id']; ?>">✎ Edit</a>
                                                <a class="button-link delete" href="plans.php?delete=<?php echo (int)$plan['id']; ?>" onclick="return confirm('Hapus rencana ini?');">🗑 Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
